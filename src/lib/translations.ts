const fr = {
  ...
  'a11y.current': 'page actuelle',
  'a11y.collapsedRail': 'barre réduite',
  'a11y.sidebarExpanded': 'Barre latérale développée',
  'a11y.sidebarCollapsed': 'Barre latérale réduite',
  'nav.tunes': 'Tunes',
  ...
  'themeStudio.open': 'Ouvrir le studio',
  'themeStudio.title': 'Studio de thèmes',
  'themeStudio.subtitle': 'Choisissez un thème puis personnalisez accent, densité, typographie et contraste.',
  'themeStudio.modeSimple': 'Simple',
  'themeStudio.modeAdvanced': 'Avancé',
  'themeStudio.reset': 'Réinitialiser',
  ...
  // Theme feature flags (admin)
  'admin.themeFlags.title': 'Thème — feature flags',
  'admin.themeFlags.subtitle': 'Configurez les options de thème côté serveur. Les écritures sont restreintes aux admins via RLS sur app_settings.',
  'admin.themeFlags.loading': 'Chargement de la configuration…',
  'admin.themeFlags.simpleMode': 'Mode Simple',
  'admin.themeFlags.simpleModeDesc': 'Affiche le sélecteur de thème simplifié dans le studio.',
  'admin.themeFlags.advancedMode': 'Mode Avancé',
  'admin.themeFlags.advancedModeDesc': 'Affiche les contrôles avancés (accent, densité, typographie, contraste).',
  'admin.themeFlags.studioRoute': 'Route /theme',
  'admin.themeFlags.studioRouteDesc': 'Active la page Studio complète. Désactivée → seul le sélecteur rapide reste.',
  'admin.themeFlags.darkLightToggle': 'Bascule clair/sombre',
  'admin.themeFlags.darkLightToggleDesc': 'Affiche le bouton clair/sombre dans le studio.',
  'admin.themeFlags.defaultTheme': 'Thème par défaut',
  'admin.themeFlags.defaultThemeDesc': 'Servi aux nouveaux visiteurs avant qu\'ils ne fassent un choix.',
  'admin.themeFlags.allowedVariants': 'Variantes autorisées',
  'admin.themeFlags.allAllowed': 'Toutes autorisées',
  'admin.themeFlags.allowedVariantsDesc': 'Si vide, tous les thèmes sont disponibles. Le thème par défaut est toujours conservé.',
  'admin.themeFlags.defaultPinned': 'Le thème par défaut ne peut pas être désactivé.',
  'admin.themeFlags.save': 'Enregistrer',
  'admin.themeFlags.saved': 'Enregistré',
  'admin.themeFlags.reset': 'Réinitialiser',
  ...
  // Préférences — menu unifié langue + thème + mode
  'settings.preferences.title': 'Préférences',
  'settings.preferences.subtitle': 'Langue, thème et mode Simple/Avancé regroupés, avec aperçu en direct.',
  'settings.preferences.preview': 'Aperçu',
  'settings.preferences.previewHint': 'Cet aperçu reflète instantanément vos choix ci-dessus.',
  'settings.preferences.modeDesc': 'Le mode Simple masque les colonnes avancées du calculateur. Vous pouvez basculer à tout moment.',
  'settings.preferences.reset': 'Réinitialiser',
  'settings.preferences.resetDone': 'Réinitialisé',
  'settings.preferences.resetConfirm': 'Réinitialiser langue, thème et mode aux valeurs par défaut ? Vos données et options d’accessibilité ne sont pas touchées.',
  'settings.preferences.dark': 'Sombre',
  'settings.preferences.light': 'Clair',
  'settings.preferences.toDark': 'Passer en sombre',
  'settings.preferences.toLight': 'Passer en clair',
  'settings.preferences.favorites': 'Favoris',
  'settings.preferences.favoritesDesc': 'Basculez rapidement entre vos sessions favorites sans repasser par le tableau de bord.',
  'settings.preferences.favoritesEmpty': 'Aucun favori. Étoile une session depuis la liste pour l’épingler ici.',
  'settings.preferences.favoritesAll': 'Tout voir',
  'settings.preferences.favoritesUnpin': 'Retirer des favoris',
  'settings.preferences.favoritesMore': 'autres',
  'settings.preferences.unitsDesc': 'Choisissez l’affichage des distances, vitesses et énergies. Les calculs balistiques restent déterministes en référence SI.',
  'settings.preferences.unitsHint': 'Conversion à l’affichage uniquement — la trajectoire et le zéro restent calculés à l’identique.',
  'settings.preferences.unitsFine': 'Réglage fin',
  'settings.preferences.unitsDistance': 'Distance',
  'settings.preferences.unitsVelocity': 'Vitesse',
  'settings.preferences.unitsEnergy': 'Énergie',
  'settings.preferences.unitsCompareValue': 'Référence',
  'settings.preferences.unitsFineTitle': 'Réglage par catégorie',
  'settings.preferences.unitsDeterministic': 'Calculs déterministes',
  'settings.preferences.unitsDeterministicDesc': 'Le moteur balistique opère toujours en référence SI (m, m/s, J). Changer d’unités ne modifie que l’affichage — les trajectoires et le zéro sont strictement identiques.',
  'settings.preferences.numberFormatTitle': 'Précision & arrondi',
  'settings.preferences.numberFormatDecimals': 'Décimales',
  'settings.preferences.numberFormatAuto': 'auto',
  'settings.preferences.numberFormatScientific': 'Notation scientifique',
  'settings.preferences.numberFormatScientificDesc': 'Très petites/grandes valeurs affichées en 1.23e-4.',
  'settings.preferences.numberFormatGrouping': 'Séparateur de milliers',
  'settings.preferences.numberFormatGroupingDesc': 'Insère un espace fin (fr) ou une virgule (en).',
  'settings.preferences.resume': 'Reprendre la dernière session',
  ...
  'settings.a11y.reduceMotion': 'Réduire les animations',
  'settings.a11y.reduceMotionDesc': 'Désactive les transitions et animations dans toute l’app, pour tous les thèmes.',
  'settings.a11y.strongFocus': 'Focus visible renforcé',
  'settings.a11y.strongFocusDesc': 'Contour de focus 3 px + halo coloré, basé sur l’accent du thème actif.',
  'settings.a11y.sidebarFocus': 'Focus à l’ouverture de la barre',
  'settings.a11y.sidebarFocusDesc': 'Quand vous développez la barre latérale, choisissez où le focus clavier atterrit.',
  'settings.a11y.sidebarFocus.first': 'Premier item',
  'settings.a11y.sidebarFocus.active': 'Item actif',
  'settings.a11y.keyboardNav': 'Mode de navigation clavier',
  'settings.a11y.keyboardNavDesc': 'Choisissez comment la touche Tab parcourt l’interface.',
  'settings.a11y.keyboardNav.normal': 'Tab normal',
  'settings.a11y.keyboardNav.cyclic': 'Tab cyclique',
  'settings.a11y.keyboardNav.normalHint': 'Tab : sort vers la barre du navigateur (URL, onglets) une fois le dernier élément atteint.',
  'settings.a11y.keyboardNav.cyclicHint': 'Tab : revient au premier élément après le dernier (et inversement avec Shift+Tab). Le focus reste dans la page.',
  'settings.a11y.keyboardNav.previewTitle': 'Aperçu dans le panneau « Plus »',
  'settings.a11y.keyboardNav.previewNormal': 'Tab depuis le dernier lien sort du panneau vers le navigateur. Les flèches ↑↓ restent toujours cycliques (pattern menu).',
  'settings.a11y.keyboardNav.previewCyclic': 'Tab depuis le dernier lien revient au premier (et Shift+Tab du premier au dernier). Le focus est confiné comme avec un dialogue modal.',
  'settings.a11y.keyboardNav.simTitle': 'Simulation interactive',
  'settings.a11y.keyboardNav.simHint': 'Utilisez Tab / Shift+Tab dans la liste ci-dessous pour voir le parcours réel du focus.',
  'settings.a11y.keyboardNav.simReset': 'Réinitialiser',
  'settings.a11y.keyboardNav.simExited': 'Tab a quitté la liste (mode normal).',
  'settings.a11y.keyboardNav.simWrapped': 'Le focus est revenu au début (mode cyclique).',
  'settings.a11y.keyboardNav.simWrappedBack': 'Le focus est passé à la fin (mode cyclique).',
  ...
  // ── FX docs (admin-editable) ───────────────────────────────────
  'docsFx.page.title': 'Documentation FX',
  'docsFx.page.subtitle': 'Limites, erreurs, FAQ météo manuelle. Recherche par tag ou contenu.',
  'docsFx.page.newSection': 'Nouvelle section',
  'docsFx.search.placeholder': 'Rechercher (titre, tags, contenu)…',
  'docsFx.search.empty': 'Aucune section ne correspond à votre recherche.',
  'docsFx.search.clearTags': 'Effacer les filtres',
  'docsFx.search.clearAll': 'Réinitialiser tous les filtres',
  'docsFx.search.categoryLabel': 'Catégorie :',
  'docsFx.search.categoryAll': 'Toutes les catégories',
  'docsFx.search.resultsCount': '{count} résultat(s) — affichage {from}–{to}',
  'docsFx.category.limits': 'Limites',
  'docsFx.category.errors': 'Erreurs',
  'docsFx.category.faq': 'FAQ',
  'docsFx.category.protocol': 'Protocole',
  'docsFx.category.general': 'Général',
  'docsFx.visibility.draft': 'Brouillon',
  'docsFx.visibility.published': 'Publié',
  'docsFx.badge.edited': 'Modifié',
  'docsFx.action.hide': 'Masquer',
  'docsFx.action.resetSeed': 'Réinitialiser',
  'docsFx.editor.titleNew': 'Nouvelle section',
  'docsFx.editor.titleEdit': 'Modifier la section',
  'docsFx.editor.description': 'Édition Markdown. Les modifications sont locales à cet appareil.',
  'docsFx.editor.fieldTitle': 'Titre',
  'docsFx.editor.fieldId': 'Identifiant',
  'docsFx.editor.fieldCategory': 'Catégorie',
  'docsFx.editor.fieldOrder': 'Ordre',
  'docsFx.editor.fieldVisibility': 'Visibilité',
  'docsFx.editor.fieldTags': 'Tags',
  'docsFx.editor.fieldBody': 'Contenu (Markdown)',
  'docsFx.editor.tabWrite': 'Édition',
  'docsFx.editor.tabPreview': 'Aperçu',
  'docsFx.editor.tagsPlaceholder': 'Ajouter…',
  'docsFx.editor.previewEmpty': 'Aperçu vide',
  'docsFx.toast.saved': 'Section enregistrée',
  'docsFx.toast.deleted': 'Section supprimée',
  'docsFx.toast.hidden': 'Section masquée',
  'docsFx.toast.reset': 'Section réinitialisée',
  'docsFx.confirm.deleteTitle': 'Supprimer cette section ?',
  'docsFx.confirm.deleteBody': 'Cette section sera définitivement supprimée de cet appareil.',
  'docsFx.confirm.hideTitle': 'Masquer cette section ?',
  'docsFx.confirm.hideBody': 'La section originale (fichier .md) restera dans le code source mais ne sera plus affichée. Vous pourrez la réafficher en réinitialisant l\u2019override.',
  'docsFx.errors.codesTitle': 'Codes d\u2019erreur de validation SI',
  'docsFx.errors.codesSubtitle': 'Référence canonique des erreurs renvoyées par le garde-fou serveur et le wrapper client. Les codes « bloquants » empêchent le calcul ; les codes « repli » autorisent un calcul local non vérifié.',
  'docsFx.errors.rangesTitle': 'Plages SI acceptées par champ',
  'docsFx.errors.rangesSubtitle': 'Toute valeur hors de ces bornes est rejetée avec le code « out-of-si-range ». Les bornes sont volontairement larges pour couvrir tous les calibres PCP.',
  'docsFx.errors.colCode': 'Code',
  'docsFx.errors.colSeverity': 'Sévérité',
  'docsFx.errors.colCause': 'Cause',
  'docsFx.errors.colMessage': 'Message utilisateur',
  'docsFx.errors.colFix': 'Action corrective',
  'docsFx.errors.colField': 'Champ',
  'docsFx.errors.colMin': 'Min',
  'docsFx.errors.colMax': 'Max',
  'docsFx.errors.colUnit': 'Unité SI',
  'docsFx.errors.colHint': 'Indice',
  'docsFx.errors.severity.hard': 'Bloquant',
  'docsFx.errors.severity.soft': 'Repli local',
  'docsFx.errors.severity.range': 'Plage',
} as const;
...
const en: Record<keyof typeof fr, string> = {
  ...
  'a11y.current': 'current page',
  'a11y.collapsedRail': 'collapsed rail',
  'a11y.sidebarExpanded': 'Sidebar expanded',
  'a11y.sidebarCollapsed': 'Sidebar collapsed',
  'nav.tunes': 'Tunes',
  'nav.compare': 'Compare',
  ...
  'themeStudio.open': 'Open studio',
  'themeStudio.title': 'Theme Studio',
  'themeStudio.subtitle': 'Pick a theme then customise accent, density, typography and contrast.',
  'themeStudio.modeSimple': 'Simple',
  'themeStudio.modeAdvanced': 'Advanced',
  'themeStudio.reset': 'Reset',
  ...
  // Theme feature flags (admin)
  'admin.themeFlags.title': 'Theme — feature flags',
  'admin.themeFlags.subtitle': 'Configure theme options server-side. Writes are restricted to admins by RLS on app_settings.',
  'admin.themeFlags.loading': 'Loading configuration…',
  'admin.themeFlags.simpleMode': 'Simple mode',
  'admin.themeFlags.simpleModeDesc': 'Show the simplified theme picker in the studio.',
  'admin.themeFlags.advancedMode': 'Advanced mode',
  'admin.themeFlags.advancedModeDesc': 'Show advanced controls (accent, density, typography, contrast).',
  'admin.themeFlags.studioRoute': '/theme route',
  'admin.themeFlags.studioRouteDesc': 'Enables the full Studio page. When off, only the quick picker remains.',
  'admin.themeFlags.darkLightToggle': 'Dark/light toggle',
  'admin.themeFlags.darkLightToggleDesc': 'Show the dark/light toggle in the studio.',
  'admin.themeFlags.defaultTheme': 'Default theme',
  'admin.themeFlags.defaultThemeDesc': 'Served to new visitors before they pick one.',
  'admin.themeFlags.allowedVariants': 'Allowed variants',
  'admin.themeFlags.allAllowed': 'All allowed',
  'admin.themeFlags.allowedVariantsDesc': 'If empty, all themes are available. The default theme is always kept.',
  'admin.themeFlags.defaultPinned': 'The default theme cannot be disabled.',
  'admin.themeFlags.save': 'Save',
  'admin.themeFlags.saved': 'Saved',
  'admin.themeFlags.reset': 'Reset',
  'admin.ai.guardrails.rls': 'Row-Level Security (RLS)',
  ...
  'calc.driftBreakdown.title': 'Where does the drift come from?',
  'calc.driftBreakdown.total': 'Total lateral',
  'calc.driftBreakdown.wind': 'Wind',
  'calc.driftBreakdown.spin': 'Gyroscopic',
  'calc.driftBreakdown.coriolis': 'Coriolis',
  'calc.driftBreakdown.modelLabel': 'Wind model',
  'calc.driftBreakdown.modelLateral': 'lateral only (Didion)',
  'calc.driftBreakdown.modelVectorial': 'vectorial (head + cross)',
  'calc.driftBreakdown.spinModel': 'Spin: Litz · SG cap ≤ 2.5 · V ≥ 200 m/s',
  'calc.driftBreakdown.spinOff': 'Spin drift disabled (profile or user setting)',
  'calc.driftBreakdown.spinForcedOn': 'Spin drift forced ON (user setting)',
  'calc.driftBreakdown.spinForcedOff': 'Spin drift forced OFF (user setting)',
  'calc.driftBreakdown.coriolisOn': 'Coriolis active',
  'calc.driftBreakdown.coriolisOff': 'Coriolis disabled',
  ...
  // Preferences — unified language + theme + mode menu
  'settings.preferences.title': 'Preferences',
  'settings.preferences.subtitle': 'Language, theme and Simple/Advanced mode grouped together, with a live preview.',
  'settings.preferences.preview': 'Preview',
  'settings.preferences.previewHint': 'This preview reflects your choices above in real time.',
  'settings.preferences.modeDesc': 'Simple hides advanced calculator columns. You can switch back any time.',
  'settings.preferences.reset': 'Reset',
  'settings.preferences.resetDone': 'Reset',
  'settings.preferences.resetConfirm': 'Reset language, theme and mode to defaults? Your data and accessibility options are kept.',
  'settings.preferences.dark': 'Dark',
  'settings.preferences.light': 'Light',
  'settings.preferences.toDark': 'Switch to dark',
  'settings.preferences.toLight': 'Switch to light',
  'settings.preferences.favorites': 'Favorites',
  'settings.preferences.favoritesDesc': 'Quickly switch between your favorite sessions without going back to the dashboard.',
  'settings.preferences.favoritesEmpty': 'No favorites yet. Star a session from the list to pin it here.',
  'settings.preferences.favoritesAll': 'See all',
  'settings.preferences.favoritesUnpin': 'Remove from favorites',
  'settings.preferences.favoritesMore': 'more',
  'settings.preferences.unitsDesc': 'Pick how distances, velocities and energies are displayed. Ballistic calculations stay deterministic in SI reference.',
  'settings.preferences.unitsHint': 'Display conversion only — trajectory and zero are still computed identically.',
  'settings.preferences.unitsFine': 'Fine-tune',
  'settings.preferences.unitsDistance': 'Distance',
  'settings.preferences.unitsVelocity': 'Velocity',
  'settings.preferences.unitsEnergy': 'Energy',
  'settings.preferences.unitsCompareValue': 'Reference',
  'settings.preferences.unitsFineTitle': 'Per-category fine-tune',
  'settings.preferences.unitsDeterministic': 'Deterministic calculations',
  'settings.preferences.unitsDeterministicDesc': 'The ballistic engine always works in SI reference (m, m/s, J). Switching units only changes the display — trajectories and zero remain strictly identical.',
  'settings.preferences.numberFormatTitle': 'Precision & rounding',
  'settings.preferences.numberFormatDecimals': 'Decimals',
  'settings.preferences.numberFormatAuto': 'auto',
  'settings.preferences.numberFormatScientific': 'Scientific notation',
  'settings.preferences.numberFormatScientificDesc': 'Very small/large values shown as 1.23e-4.',
  'settings.preferences.numberFormatGrouping': 'Thousands separator',
  'settings.preferences.numberFormatGroupingDesc': 'Inserts a thin space (fr) or a comma (en).',
  'settings.preferences.resume': 'Resume last session',
  ...
  'settings.a11y.reduceMotionDesc': 'Disables transitions and animations across the app, for every theme.',
  'settings.a11y.strongFocus': 'Strong visible focus',
  'settings.a11y.strongFocusDesc': '3px focus outline + coloured halo, derived from the active theme accent.',
  'settings.a11y.sidebarFocus': 'Sidebar expand focus',
  'settings.a11y.sidebarFocusDesc': 'When you expand the sidebar, choose where keyboard focus lands.',
  'settings.a11y.sidebarFocus.first': 'First item',
  'settings.a11y.sidebarFocus.active': 'Active item',
  'settings.a11y.keyboardNav': 'Keyboard navigation mode',
  'settings.a11y.keyboardNavDesc': 'Choose how the Tab key moves through the interface.',
  'settings.a11y.keyboardNav.normal': 'Normal Tab',
  'settings.a11y.keyboardNav.cyclic': 'Cyclic Tab',
  'settings.a11y.keyboardNav.normalHint': 'Tab: leaves to the browser chrome (URL, tabs) once the last element is reached.',
  'settings.a11y.keyboardNav.cyclicHint': 'Tab: wraps from the last element back to the first (and Shift+Tab from first to last). Focus stays in the page.',
  'settings.a11y.keyboardNav.previewTitle': 'Preview in the "More" panel',
  'settings.a11y.keyboardNav.previewNormal': 'Tab from the last link exits the panel into the browser chrome. Arrow keys ↑↓ remain cyclic (menu pattern).',
  'settings.a11y.keyboardNav.previewCyclic': 'Tab from the last link wraps to the first (and Shift+Tab from first to last). Focus is confined like a modal dialog.',
  'settings.a11y.keyboardNav.simTitle': 'Interactive simulation',
  'settings.a11y.keyboardNav.simHint': 'Use Tab / Shift+Tab in the list below to see the actual focus path.',
  'settings.a11y.keyboardNav.simReset': 'Reset',
  'settings.a11y.keyboardNav.simExited': 'Tab left the list (normal mode).',
  'settings.a11y.keyboardNav.simWrapped': 'Focus wrapped back to the start (cyclic mode).',
  'settings.a11y.keyboardNav.simWrappedBack': 'Focus wrapped to the end (cyclic mode).',
  ...
  // ── FX docs (admin-editable) ───────────────────────────────────
  'docsFx.page.title': 'FX Documentation',
  'docsFx.page.subtitle': 'Limits, errors, manual weather FAQ. Search by tag or content.',
  'docsFx.page.newSection': 'New section',
  'docsFx.search.placeholder': 'Search (title, tags, content)…',
  'docsFx.search.empty': 'No section matches your search.',
  'docsFx.search.clearTags': 'Clear filters',
  'docsFx.search.clearAll': 'Reset all filters',
  'docsFx.search.categoryLabel': 'Category:',
  'docsFx.search.categoryAll': 'All categories',
  'docsFx.search.resultsCount': '{count} result(s) — showing {from}–{to}',
  'docsFx.category.limits': 'Limits',
  'docsFx.category.errors': 'Errors',
  'docsFx.category.faq': 'FAQ',
  'docsFx.category.protocol': 'Protocol',
  'docsFx.category.general': 'General',
  'docsFx.visibility.draft': 'Draft',
  'docsFx.visibility.published': 'Published',
  'docsFx.badge.edited': 'Edited',
  'docsFx.action.hide': 'Hide',
  'docsFx.action.resetSeed': 'Reset',
  'docsFx.editor.titleNew': 'New section',
  'docsFx.editor.titleEdit': 'Edit section',
  'docsFx.editor.description': 'Markdown editor. Edits are local to this device.',
  'docsFx.editor.fieldTitle': 'Title',
  'docsFx.editor.fieldId': 'Identifier',
  'docsFx.editor.fieldCategory': 'Category',
  'docsFx.editor.fieldOrder': 'Order',
  'docsFx.editor.fieldVisibility': 'Visibility',
  'docsFx.editor.fieldTags': 'Tags',
  'docsFx.editor.fieldBody': 'Content (Markdown)',
  'docsFx.editor.tabWrite': 'Write',
  'docsFx.editor.tabPreview': 'Preview',
  'docsFx.editor.tagsPlaceholder': 'Add…',
  'docsFx.editor.previewEmpty': 'Empty preview',
  'docsFx.toast.saved': 'Section saved',
  'docsFx.toast.deleted': 'Section deleted',
  'docsFx.toast.hidden': 'Section hidden',
  'docsFx.toast.reset': 'Section reset',
  'docsFx.confirm.deleteTitle': 'Delete this section?',
  'docsFx.confirm.deleteBody': 'This section will be permanently deleted from this device.',
  'docsFx.confirm.hideTitle': 'Hide this section?',
  'docsFx.confirm.hideBody': 'The original section (.md file) will stay in the source code but will no longer be displayed. You can show it again by resetting the override.',
  'docsFx.errors.codesTitle': 'SI validation error codes',
  'docsFx.errors.codesSubtitle': 'Canonical reference of errors returned by the server guardrail and the client wrapper. "Blocking" codes prevent the calculation; "soft fallback" codes allow an unverified local calculation.',
  'docsFx.errors.rangesTitle': 'SI ranges accepted per field',
  'docsFx.errors.rangesSubtitle': 'Any value outside these bounds is rejected with code "out-of-si-range". Bounds are deliberately wide to cover all PCP calibers.',
  'docsFx.errors.colCode': 'Code',
  'docsFx.errors.colSeverity': 'Severity',
  'docsFx.errors.colCause': 'Cause',
  'docsFx.errors.colMessage': 'User message',
  'docsFx.errors.colFix': 'Fix',
  'docsFx.errors.colField': 'Field',
  'docsFx.errors.colMin': 'Min',
  'docsFx.errors.colMax': 'Max',
  'docsFx.errors.colUnit': 'SI unit',
  'docsFx.errors.colHint': 'Hint',
  'docsFx.errors.severity.hard': 'Blocking',
  'docsFx.errors.severity.soft': 'Local fallback',
  'docsFx.errors.severity.range': 'Range',
};
