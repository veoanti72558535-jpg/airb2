const fr = {
  ...
  // Web Bluetooth compatibility guide
  'chrono.compat.iosTitle': 'Web Bluetooth indisponible sur iOS',
  'chrono.compat.iosBody': 'Apple n\'autorise pas Web Bluetooth dans Safari ni dans aucun navigateur sur iPhone/iPad (tous utilisent WebKit).',
  'chrono.compat.firefoxTitle': 'Firefox ne supporte pas Web Bluetooth',
  'chrono.compat.firefoxBody': 'Mozilla a explicitement refusé d\'implémenter Web Bluetooth pour des raisons de sécurité et de vie privée.',
  'chrono.compat.safariTitle': 'Safari ne supporte pas Web Bluetooth',
  'chrono.compat.safariBody': 'Apple n\'a pas implémenté Web Bluetooth dans Safari, ni sur macOS ni sur iOS.',
  'chrono.compat.insecureTitle': 'Contexte non sécurisé',
  'chrono.compat.insecureBody': 'Web Bluetooth ne fonctionne qu\'en HTTPS ou sur localhost. Cette page est servie en HTTP.',
  'chrono.compat.noApiTitle': 'API Web Bluetooth indisponible',
  'chrono.compat.noApiBody': 'Votre navigateur ne propose pas navigator.bluetooth. Mettez-le à jour ou activez l\'option dans les paramètres.',
  'chrono.compat.unknownTitle': 'Bluetooth indisponible',
  'chrono.compat.unknownBody': 'Impossible d\'accéder au Bluetooth depuis ce navigateur.',
  'chrono.compat.detected': 'Détecté',
  'chrono.compat.checkCompat': 'Vérifier la compatibilité',
  'chrono.compat.tip.useAndroid': 'Utilisez Chrome ou Edge sur Android',
  'chrono.compat.tip.bluefyApp': 'Sur iOS, essayez l\'app « Bluefy » qui implémente Web Bluetooth en contournant WebKit',
  'chrono.compat.tip.useDesktop': 'Utilisez Chrome, Edge ou Opera sur ordinateur (Windows, macOS, Linux)',
  'chrono.compat.tip.installChrome': 'Installez Google Chrome',
  'chrono.compat.tip.installEdge': 'Installez Microsoft Edge',
  'chrono.compat.tip.https': 'Accédez à l\'app via HTTPS',
  'chrono.compat.tip.localhost': 'En développement local, utilisez localhost (pas l\'IP)',
  'chrono.compat.tip.updateBrowser': 'Mettez votre navigateur à jour',
  'chrono.compat.tip.enableFlag': 'Vérifiez chrome://flags pour « Experimental Web Platform features »',
  'chrono.compat.tip.osBluetooth': 'Activez le Bluetooth dans les paramètres système',
  // First-time pairing onboarding
  'chrono.firstConnect.title': 'Première connexion : sélectionnez votre FX Radar',
  'chrono.firstConnect.body': 'À la première connexion, le navigateur affiche la liste de tous les appareils Bluetooth à proximité. Vous devez choisir manuellement votre FX Radar — l\'app le mémorisera ensuite pour les fois suivantes.',
  'chrono.firstConnect.step1': 'Allumez le FX Radar et placez-le à moins de 2 m',
  'chrono.firstConnect.step2': 'Cliquez sur « Connecter FX Radar »',
  'chrono.firstConnect.step3': 'Dans la fenêtre du navigateur, cherchez « FX Radar » ou « FX Chrono » puis cliquez sur « Appairer »',
  'chrono.firstConnect.tip': 'Astuce : si vous voyez beaucoup d\'appareils, le FX Radar apparaît généralement avec un nom commençant par « FX » ou un identifiant alphanumérique.',
  'chrono.firstConnect.scanningHint': 'Une fenêtre Bluetooth est ouverte par votre navigateur — sélectionnez votre FX Radar dans la liste, puis cliquez sur « Appairer ».',
  // FX model heuristic (BLE diagnostic)
  'chrono.diag.fxGuess.probable': 'Probable',
  'chrono.diag.fxGuess.modelRadar': 'FX Radar',
  'chrono.diag.fxGuess.modelChrono': 'FX Chrono',
  'chrono.diag.fxGuess.modelUnknown': 'Inconnu',
  'chrono.diag.fxGuess.disclaimer': 'Estimation basée sur le nom annoncé et les services GATT exposés. Les UUID FX ne sont pas officiellement documentés — ne considérez jamais cette détection comme certaine.',
  'chrono.diag.fxGuess.signalsTitle': 'Indices détectés',
  'chrono.diag.fxGuess.signal.name-radar': 'Nom contient « radar »',
  'chrono.diag.fxGuess.signal.name-chrono': 'Nom contient « chrono »',
  'chrono.diag.fxGuess.signal.name-fx-prefix': 'Nom commence par « FX »',
  'chrono.diag.fxGuess.signal.svc-fff0': 'Service 0xFFF0 (série Nordic, courant FX Radar)',
  'chrono.diag.fxGuess.signal.svc-1523-nordic': 'Service Nordic LBS (vu sur FX Chrono)',
  ...
  'chrono.gatt.status.ok': 'OK',
  'chrono.gatt.status.error': 'Erreur',
  'chrono.gatt.stage.request-device': 'Sélection appareil',
  'chrono.gatt.stage.connect-gatt': 'Connexion GATT',
  'chrono.gatt.stage.discover-services': 'Découverte services',
  'chrono.gatt.stage.find-characteristic': 'Recherche caractéristique',
  'chrono.gatt.stage.start-notifications': 'Activation notifications',
  'chrono.gatt.stage.streaming': 'Réception données',
  'chrono.gatt.stage.disconnected': 'Déconnecté',
  'chrono.gatt.stage.error': 'Erreur',
...
const en: Record<keyof typeof fr, string> = {
  ...
  // Web Bluetooth compatibility guide
  'chrono.compat.iosTitle': 'Web Bluetooth unavailable on iOS',
  'chrono.compat.iosBody': 'Apple does not allow Web Bluetooth in Safari or any browser on iPhone/iPad (all use WebKit).',
  'chrono.compat.firefoxTitle': 'Firefox does not support Web Bluetooth',
  'chrono.compat.firefoxBody': 'Mozilla has explicitly declined to implement Web Bluetooth for security and privacy reasons.',
  'chrono.compat.safariTitle': 'Safari does not support Web Bluetooth',
  'chrono.compat.safariBody': 'Apple has not implemented Web Bluetooth in Safari, on either macOS or iOS.',
  'chrono.compat.insecureTitle': 'Insecure context',
  'chrono.compat.insecureBody': 'Web Bluetooth only works on HTTPS or localhost. This page is served over plain HTTP.',
  'chrono.compat.noApiTitle': 'Web Bluetooth API unavailable',
  'chrono.compat.noApiBody': 'Your browser does not expose navigator.bluetooth. Update it or enable the feature in settings.',
  'chrono.compat.unknownTitle': 'Bluetooth unavailable',
  'chrono.compat.unknownBody': 'Unable to access Bluetooth from this browser.',
  'chrono.compat.detected': 'Detected',
  'chrono.compat.checkCompat': 'Check compatibility',
  'chrono.compat.tip.useAndroid': 'Use Chrome or Edge on Android',
  'chrono.compat.tip.bluefyApp': 'On iOS, try the "Bluefy" app which implements Web Bluetooth on top of WebKit',
  'chrono.compat.tip.useDesktop': 'Use Chrome, Edge, or Opera on desktop (Windows, macOS, Linux)',
  'chrono.compat.tip.installChrome': 'Install Google Chrome',
  'chrono.compat.tip.installEdge': 'Install Microsoft Edge',
  'chrono.compat.tip.https': 'Access the app via HTTPS',
  'chrono.compat.tip.localhost': 'For local development, use localhost (not the IP)',
  'chrono.compat.tip.updateBrowser': 'Update your browser',
  'chrono.compat.tip.enableFlag': 'Check chrome://flags for "Experimental Web Platform features"',
  'chrono.compat.tip.osBluetooth': 'Enable Bluetooth in your system settings',
  // First-time pairing onboarding
  'chrono.firstConnect.title': 'First connection: select your FX Radar',
  'chrono.firstConnect.body': 'On the first connection, the browser shows the list of all Bluetooth devices nearby. You need to manually choose your FX Radar — the app will remember it for next time.',
  'chrono.firstConnect.step1': 'Power on the FX Radar and place it within 2 m',
  'chrono.firstConnect.step2': 'Click "Connect FX Radar"',
  'chrono.firstConnect.step3': 'In the browser dialog, look for "FX Radar" or "FX Chrono" and click "Pair"',
  'chrono.firstConnect.tip': 'Tip: if many devices appear, the FX Radar usually shows up with a name starting with "FX" or an alphanumeric identifier.',
  'chrono.firstConnect.scanningHint': 'A Bluetooth window has been opened by your browser — pick your FX Radar from the list, then click "Pair".',
  // FX model heuristic (BLE diagnostic)
  'chrono.diag.fxGuess.probable': 'Probable',
  'chrono.diag.fxGuess.modelRadar': 'FX Radar',
  'chrono.diag.fxGuess.modelChrono': 'FX Chrono',
  'chrono.diag.fxGuess.modelUnknown': 'Unknown',
  'chrono.diag.fxGuess.disclaimer': 'Heuristic guess based on the advertised name and exposed GATT services. FX UUIDs are not officially documented — never treat this as certain.',
  'chrono.diag.fxGuess.signalsTitle': 'Detected signals',
  'chrono.diag.fxGuess.signal.name-radar': 'Name contains "radar"',
  'chrono.diag.fxGuess.signal.name-chrono': 'Name contains "chrono"',
  'chrono.diag.fxGuess.signal.name-fx-prefix': 'Name starts with "FX"',
  'chrono.diag.fxGuess.signal.svc-fff0': 'Service 0xFFF0 (Nordic serial, common on FX Radar)',
  'chrono.diag.fxGuess.signal.svc-1523-nordic': 'Nordic LBS service (seen on FX Chrono)',
  ...
  'chrono.gatt.status.ok': 'OK',
  'chrono.gatt.status.error': 'Error',
  'chrono.gatt.stage.request-device': 'Device selection',
  'chrono.gatt.stage.connect-gatt': 'GATT connect',
  'chrono.gatt.stage.discover-services': 'Service discovery',
  'chrono.gatt.stage.find-characteristic': 'Find characteristic',
  'chrono.gatt.stage.start-notifications': 'Start notifications',
  'chrono.gatt.stage.streaming': 'Receiving data',
  'chrono.gatt.stage.disconnected': 'Disconnected',
  'chrono.gatt.stage.error': 'Error',
