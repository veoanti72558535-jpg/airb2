const fr = {
  ...
  // G1 drag-source picker (advanced mode)
  'g1Source.title': 'Table de traînée G1',
  'g1Source.legacyTitle': 'G1 historique (4 segments)',
  'g1Source.legacyDesc': 'Approximation rapide. Compatible bit-pour-bit avec les sessions sauvegardées avant cette option.',
  'g1Source.chairgunTitle': 'G1 ChairGun (79 pts)',
  'g1Source.chairgunDesc': 'Table de référence ChairGun Elite, plus précise sur le subsonique haut et le transsonique.',
  'g1Source.customActive': 'Table Cd personnalisée',
  'g1Source.disabledNonG1': 'Désactivé : la loi de traînée active n\u2019est pas G1.',
  'g1Source.disabledCustomTable': 'Désactivé : une table Cd personnalisée du projectile prime sur G1.',
  // Integrator side-by-side comparison (advanced mode)
  'integratorCompare.title': 'Comparer Euler ↔ Heun',
  'integratorCompare.toggleOn': 'Afficher la comparaison',
  'integratorCompare.toggleOff': 'Masquer la comparaison',
  'integratorCompare.hint': 'Recalcule la trajectoire avec l\u2019autre intégrateur — utile pour estimer l\u2019erreur de la méthode (les deux modèles partagent exactement les mêmes inputs et la même physique).',
  'integratorCompare.sessionUses': 'SESSION : intégrateur',
  'integratorCompare.alt': 'Alternatif',
  'integratorCompare.colRange': 'Distance',
  'integratorCompare.colDrop': 'Chute',
  'integratorCompare.colWind': 'Dérive',
  'integratorCompare.colVelocity': 'Vitesse',
  'integratorCompare.colDelta': 'Δ',
  'integratorCompare.errorRecalc': 'Échec du recalcul alternatif. Données conservées intactes.',
  'integratorCompare.maxAbsDelta': 'Δ max |chute|',
...
const en: Record<keyof typeof fr, string> = {
  ...
  // G1 drag-source picker (advanced mode)
  'g1Source.title': 'G1 drag table',
  'g1Source.legacyTitle': 'G1 legacy (4 segments)',
  'g1Source.legacyDesc': 'Fast piecewise approximation. Bit-exact with sessions saved before this option existed.',
  'g1Source.chairgunTitle': 'G1 ChairGun (79 pts)',
  'g1Source.chairgunDesc': 'ChairGun Elite reference table, more accurate in the upper subsonic and transonic regimes.',
  'g1Source.customActive': 'Custom Cd table',
  'g1Source.disabledNonG1': 'Disabled: the active drag law is not G1.',
  'g1Source.disabledCustomTable': 'Disabled: a custom projectile Cd table overrides G1.',
  // Integrator side-by-side comparison (advanced mode)
  'integratorCompare.title': 'Compare Euler ↔ Heun',
  'integratorCompare.toggleOn': 'Show comparison',
  'integratorCompare.toggleOff': 'Hide comparison',
  'integratorCompare.hint': 'Recomputes the trajectory with the other integrator — handy to estimate the method error (both runs share the exact same inputs and physics).',
  'integratorCompare.sessionUses': 'SESSION integrator',
  'integratorCompare.alt': 'Alternative',
  'integratorCompare.colRange': 'Range',
  'integratorCompare.colDrop': 'Drop',
  'integratorCompare.colWind': 'Wind',
  'integratorCompare.colVelocity': 'Velocity',
  'integratorCompare.colDelta': 'Δ',
  'integratorCompare.errorRecalc': 'Alternate recomputation failed. Stored data left untouched.',
  'integratorCompare.maxAbsDelta': 'Max |drop| Δ',
  'sessionDetail.notes': 'Notes',
