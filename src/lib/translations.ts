const fr = {
  ...
  'dope.export.button': 'Exporter DOPE Card (PDF)',
  'dope.export.loading': 'Génération en cours...',
  'dope.export.error': 'Erreur lors de la génération du PDF',
  'dope.export.title': 'DOPE Card',
  'dope.export.generatedBy': 'Généré par AirBallistik',
  'dope.export.aiWarning': 'Données IA — confidence C — vérifier avant utilisation',
  'dope.section.weapon': 'Arme & Optique',
  'dope.section.projectile': 'Projectile',
...
const en: Record<keyof typeof fr, string> = {
  ...
  'dope.export.button': 'Export DOPE Card (PDF)',
  'dope.export.loading': 'Generating...',
  'dope.export.error': 'PDF generation failed',
  'dope.export.title': 'DOPE Card',
  'dope.export.generatedBy': 'Generated by AirBallistik',
  'dope.export.aiWarning': 'AI data — confidence C — verify before use',
  'dope.section.weapon': 'Weapon & Optic',
  'dope.section.projectile': 'Projectile',
