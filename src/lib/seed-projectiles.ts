...
export const SEED_PROJECTILES: SeedProjectile[] = [
  ...
  // .177 (4.50 mm) — PELLETS
  // ============================================================
  { brand: 'JSB', model: 'Exact Diabolo 8.44gr', weight: 8.44, bc: 0.022, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'domed', diameter: 4.52, material: 'lead', dataSource: JSB, notes: 'Plinking & FT — vélocités modérées' },
  { brand: 'JSB', model: 'Exact Heavy 10.34gr', weight: 10.34, bc: 0.026, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'domed', diameter: 4.52, material: 'lead', dataSource: JSB, notes: 'Polyvalent FT/HFT' },
  { brand: 'JSB', model: 'Hades 10.34gr', weight: 10.34, bc: 0.020, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'hollow', diameter: 4.52, material: 'lead', dataSource: JSB, notes: 'Hunting hollow point' },
  { brand: 'JSB', model: 'Exact Monster 13.43gr', weight: 13.43, bc: 0.029, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'domed', diameter: 4.52, material: 'lead', dataSource: JSB, notes: 'Lourd — PCP haut régime' },
  ...
  { brand: 'H&N', model: 'Field Target Trophy 8.64gr', weight: 8.64, bc: 0.020, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'domed', diameter: 4.51, material: 'lead', dataSource: HN, notes: 'FT classique' },
  { brand: 'H&N', model: 'Baracuda Match 10.65gr', weight: 10.65, bc: 0.025, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'domed', diameter: 4.50, material: 'lead', dataSource: HN, notes: 'Hunting / longues distances' },
  { brand: 'H&N', model: 'Baracuda Hunter Extreme 9.57gr', weight: 9.57, bc: 0.021, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'hollow', diameter: 4.50, material: 'lead', dataSource: HN, notes: 'Expansion sur gibier' },
  ...
  { brand: 'Crosman', model: 'Premier Heavy 10.5gr', weight: 10.5, bc: 0.024, bcModel: 'G1', caliber: '.177', projectileType: 'pellet', shape: 'domed', diameter: 4.52, material: 'lead', dataSource: HAM, notes: 'Boîte cardboard CPHP' },
  ...
  // ============================================================
  // .22 (5.50 / 5.52 mm) — PELLETS
  // ============================================================
  { brand: 'JSB', model: 'Exact Jumbo 14.35gr', weight: 14.35, bc: 0.030, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.51, material: 'lead', dataSource: JSB, notes: 'Standard FT/HFT .22' },
  ...
  { brand: 'JSB', model: 'Exact Jumbo Heavy 18.13gr', weight: 18.13, bc: 0.033, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.52, material: 'lead', dataSource: JSB, notes: 'Référence longue distance .22' },
  ...
  { brand: 'H&N', model: 'Field Target Trophy 14.66gr', weight: 14.66, bc: 0.025, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'FT classique .22' },
  { brand: 'H&N', model: 'Baracuda Match 21.14gr', weight: 21.14, bc: 0.036, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Long range / hunting' },
  ...
  { brand: 'H&N', model: 'Baracuda Hunter Extreme 18.52gr', weight: 18.52, bc: 0.027, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'hollow', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Hollow expansion' },
  ...
  { brand: 'Crosman', model: 'Premier Domed 14.3gr', weight: 14.3, bc: 0.027, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'lead', dataSource: HAM, notes: 'Boîte cardboard CPHP' },
  ...
  // .25 (6.35 mm) — PELLETS
  // ============================================================
  { brand: 'JSB', model: 'Exact King 25.39gr', weight: 25.39, bc: 0.040, bcModel: 'G1', caliber: '.25', projectileType: 'pellet', shape: 'domed', diameter: 6.35, material: 'lead', dataSource: JSB, notes: 'Référence FT/HFT .25' },
  { brand: 'JSB', model: 'Exact King Heavy 33.95gr', weight: 33.95, bc: 0.052, bcModel: 'G1', caliber: '.25', projectileType: 'pellet', shape: 'domed', diameter: 6.35, material: 'lead', dataSource: JSB, notes: 'Long range .25' },
  { brand: 'JSB', model: 'Exact King MKII 25.39gr', weight: 25.39, bc: 0.041, bcModel: 'G1', caliber: '.25', projectileType: 'pellet', shape: 'domed', diameter: 6.35, material: 'lead', dataSource: JSB, notes: 'Version révisée' },
  ...
  { brand: 'JSB', model: 'Monster 33.95gr', weight: 33.95, bc: 0.054, bcModel: 'G1', caliber: '.25', projectileType: 'pellet', shape: 'domed', diameter: 6.35, material: 'lead', dataSource: JSB, notes: 'PCP haut régime' },
  { brand: 'H&N', model: 'Baracuda 31.02gr', weight: 31.02, bc: 0.045, bcModel: 'G1', caliber: '.25', projectileType: 'pellet', shape: 'domed', diameter: 6.35, material: 'lead', dataSource: HN, notes: 'Hunting longue distance' },
  { brand: 'H&N', model: 'Slug HP II 34gr', weight: 34.0, bc: 0.090, bcModel: 'G1', caliber: '.25', projectileType: 'slug', shape: 'slug', diameter: 6.35, material: 'lead', dataSource: HN, notes: 'Slug .25 HP — barrel slug-ready' },
