...
export const SEED_PROJECTILES: SeedProjectile[] = [
  ...
  { brand: 'JSB', model: 'Hades Monster 25.39gr', weight: 25.39, bc: 0.038, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'hollow', diameter: 5.52, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/hades/137-hades-monster-22-5-5.html', notes: 'Hollow point lourd — chasse PCP haut régime' },
  ...
  { brand: 'H&N', model: 'Slug HP 30gr', weight: 30.0, bc: 0.090, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.51, material: 'lead', dataSource: HN, notes: 'Slug .22 hollow point très lourd' },
  { brand: 'H&N', model: 'Slug HP II 25gr', weight: 25.0, bc: 0.082, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.51, material: 'lead', dataSource: HN, notes: 'Slug HP II — profil amélioré' },
  { brand: 'H&N', model: 'Slug HP II 28gr', weight: 28.0, bc: 0.088, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.51, material: 'lead', dataSource: HN, notes: 'Slug HP II standard long range' },
  ...
  { brand: 'H&N', model: 'Field Target Trophy Power 21.14gr', weight: 21.14, bc: 0.034, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'FT Power — version lourde' },
  { brand: 'H&N', model: 'Baracuda Hunter Extreme 18.52gr (5.51)', weight: 18.52, bc: 0.027, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'hollow', diameter: 5.51, material: 'lead', dataSource: HN, notes: 'Hollow extrême — die 5.51' },
  { brand: 'H&N', model: 'Baracuda Green 12.35gr', weight: 12.35, bc: 0.020, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'tin', dataSource: HN, notes: 'Plomb-free étain — high velocity' },
  { brand: 'H&N', model: 'Baracuda FT 21.14gr', weight: 21.14, bc: 0.038, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.51, material: 'lead', dataSource: HN, notes: 'Field Target — die optimisée' },
  { brand: 'H&N', model: 'Coppa Match 14.66gr', weight: 14.66, bc: 0.025, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'copper-plated', dataSource: HN, notes: 'Plomb cuivré — anti-encrassement' },
  { brand: 'H&N', model: 'Match Pistol 14.66gr', weight: 14.66, bc: 0.020, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'wadcutter', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Wadcutter match 10m' },
  { brand: 'H&N', model: 'Excite Hammer 14.66gr', weight: 14.66, bc: 0.022, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'flat', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Plinking flat-nose économique' },
  { brand: 'H&N', model: 'Excite Spike 15.74gr', weight: 15.74, bc: 0.024, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'pointed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Pointe — plinking économique' },
  { brand: 'H&N', model: 'Rabbit Magnum II 25.85gr', weight: 25.85, bc: 0.040, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Hunting très lourd — high power PCP' },
  { brand: 'H&N', model: 'Piledriver 30.86gr', weight: 30.86, bc: 0.046, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'domed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Pellet ultra-lourd — magnum hunting' },
  { brand: 'H&N', model: 'Crow Magnum II 18.21gr', weight: 18.21, bc: 0.026, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'hollow', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Hollow — version II expansion' },
  { brand: 'H&N', model: 'Silver Point 17.13gr', weight: 17.13, bc: 0.024, bcModel: 'G1', caliber: '.22', projectileType: 'pellet', shape: 'pointed', diameter: 5.50, material: 'lead', dataSource: HN, notes: 'Pointe argentée — pénétration' },
  ...
  { brand: 'JSB', model: 'KnockOut Slug .177 (4.51) 10.03gr', weight: 10.03, bc: 0.040, bcModel: 'G1', caliber: '.177', projectileType: 'slug', shape: 'slug', diameter: 4.51, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/119-knockout-177-4-51-0-650g.html', notes: 'Slug .177 léger — 0.650g' },
  { brand: 'JSB', model: 'KnockOut Slug .177 (4.52) 13.43gr', weight: 13.43, bc: 0.048, bcModel: 'G1', caliber: '.177', projectileType: 'slug', shape: 'slug', diameter: 4.52, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/120-knockout-slugs-177-4-52-0-870g.html', notes: 'Slug .177 standard — 0.870g' },
  { brand: 'JSB', model: 'KnockOut Slug .177 MKII (4.51) 13.43gr', weight: 13.43, bc: 0.050, bcModel: 'G1', caliber: '.177', projectileType: 'slug', shape: 'slug', diameter: 4.51, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/127-knockout-slugs-177-mkii-4-51.html', notes: 'Slug .177 MKII — profil amélioré' },
  { brand: 'JSB', model: 'KnockOut Slug .177 MK3 (4.51) 13.43gr', weight: 13.43, bc: 0.052, bcModel: 'G1', caliber: '.177', projectileType: 'slug', shape: 'slug', diameter: 4.51, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/139-knockout-slugs-177-mk3-4-51.html', notes: 'Slug .177 MK3 — dernière révision' },
  { brand: 'JSB', model: 'KnockOut Slug .216 (5.5) 18.52gr', weight: 18.52, bc: 0.060, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.49, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/138-knockout-slugs-216-5-5.html', notes: 'Slug .216 (5.49mm) léger' },
  { brand: 'JSB', model: 'KnockOut Slug .216 (5.5) 20.83gr', weight: 20.83, bc: 0.064, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.49, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/141-knockout-slugs-216-5-5-1-350g.html', notes: 'Slug .216 — 1.350g' },
  { brand: 'JSB', model: 'KnockOut Slug .216 MKII (5.49) 22.66gr', weight: 22.66, bc: 0.070, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.49, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/117-knockout-slugs-216-mkii-5-49.html', notes: 'Slug .216 MKII (5.49) — profil amélioré' },
  { brand: 'JSB', model: 'KnockOut Slug .217 (5.5) 22.66gr', weight: 22.66, bc: 0.068, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.51, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/116-knockout-slugs-217-5-5.html', notes: 'Slug .217 (5.51mm) standard' },
  { brand: 'JSB', model: 'KnockOut Slug .217 (5.5) 28.55gr', weight: 28.55, bc: 0.078, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.51, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/142-knockout-slugs-217-5-5-1-850g.html', notes: 'Slug .217 — 1.850g lourd' },
  { brand: 'JSB', model: 'KnockOut Slug .218 (5.5) 25.39gr', weight: 25.39, bc: 0.073, bcModel: 'G1', caliber: '.22', projectileType: 'slug', shape: 'slug', diameter: 5.53, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/124-knockout-slugs-218-5-5.html', notes: 'Slug .218 (5.53mm) — die large' },
  { brand: 'JSB', model: 'KnockOut Slug .251 (6.37) 35.16gr', weight: 35.16, bc: 0.092, bcModel: 'G1', caliber: '.25', projectileType: 'slug', shape: 'slug', diameter: 6.37, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/112-knockout-slugs-251-6-37.html', notes: 'Slug .251 (6.37mm)' },
  { brand: 'JSB', model: 'KnockOut Slug .25 MKII (6.35) 33.95gr', weight: 33.95, bc: 0.090, bcModel: 'G1', caliber: '.25', projectileType: 'slug', shape: 'slug', diameter: 6.35, material: 'lead', dataSource: 'https://www.schulzdiabolo.cz/en/pellets/slugs/115-knockout-25-mkii-6-35.html', notes: 'Slug .25 MKII — profil amélioré' },
];
