...
describe('AgentButton', () => {
  ...
  it('renders button in idle state', () => {
    render(<AgentButton agentSlug="test-agent" prompt="test" buttonLabel="Test" testIdPrefix="ta" />);
  ...
  it('calls queryAIViaEdge with correct slug on click', async () => {
    ...
    render(<AgentButton agentSlug="my-agent" prompt="hello" buttonLabel="Go" testIdPrefix="ta" />);
  ...
  it('shows confidence:C badge after response', async () => {
    ...
    render(<AgentButton agentSlug="a" prompt="p" buttonLabel="B" testIdPrefix="ta" />);
    fireEvent.click(screen.getByTestId('ta-btn'));
...
describe('DeviationExplainer', () => {
  it('renders without error', async () => {
    ...
    render(<DeviationExplainer distanceM={50} driftMm={12.5} />);
...
describe('ProjectileSummary', () => {
  it('renders without error', async () => {
    ...
    render(<ProjectileSummary projectile={p} />);
...
describe('SessionSummarizer', () => {
  it('renders without error', async () => {
    ...
    render(<SessionSummarizer session={s} />);
...
describe('CompareInsights', () => {
  it('renders without error', async () => {
    ...
    render(<CompareInsights sessionA={s} sessionB={s} />);
